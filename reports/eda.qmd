...
X_train, X_test, y_train, y_test = train_test_split(X,y, test_size=0.2, randomstate=123)
...
numeric_data.remove('last_review')

date_data = ['year', 'month','day']

# Performing imputation on the null values in our date info
for i in date_date:
    X_train = impute_random(X_train, i)
    X-test = imput_random(X_train, i)
...
preprocessor = make_column_transformer(
    ('drop', drop_data),
    (numeric_transfomer, numerical_data),
    (categorical_transfrmer, categorical_data),
    (text_transofmer, text_data),
